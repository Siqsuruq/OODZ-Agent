namespace eval ::plugins::edit_file {}

proc ::plugins::edit_file::execute {workspaceRoot arguments settings} {
    set relativePath [dict get $arguments path]
    set oldText [dict get $arguments old_text]
    set newText [dict get $arguments new_text]
    if {[string trim $relativePath] eq ""} {
    ...
    return "Edited file: $relativePath"
}
